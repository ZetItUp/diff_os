...
// Simple limits for bus/device/function scanning
#define PCI_MAX_BUS         256
#define PCI_MAX_DEV         32
#define PCI_MAX_FUNC        8

// Config access via 0xCF8/0xCFC
#define PCI_CONFIG_ADDR     0xCF8
#define PCI_CONFIG_DATA     0xCFC

// Offsets inside the 256-byte config header
...
// Callbacks
typedef void (*pci_enum_callback_t)(const pci_device_t *dev, void *context);
void pci_enum_devices(pci_enum_callback_t callback, void *context);

// Direct config register access
